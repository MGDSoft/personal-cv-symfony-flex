...
final class Kernel extends BaseKernel
{
    ...
    public function extraBundlesAddedManually(): array
    {
        return [
            // Alice
            ...
            'Youshido\GraphQLBundle\GraphQLBundle' => ['all' => true],
        ];
    }

    public function registerBundles(): iterable
    {
        $contents = array_merge(require dirname(__DIR__).'/config/bundles.php', $this->extraBundlesAddedManually());
